...
%  
% GENERATES AN 11-PARAMETER ERROR BUDGET FOR A HIGH-ACCURACY INERTIAL
% NAVIGATION SYSTEM WITH ABOUT 0.1 NAUTICAL MILES PER HOUR CEP RATE, USING 
...
%
% ERROR BUDGET CAN BE saveD TO FILE 'INSEBHiAcc.mat'
%
...
%
EB(1)   = 1e-5;
EB(2)   = 1e-4/3600/180*pi;      % .0001 deg/hr/sqrt(s)
EB(3)   = 15;                    % 15 for 0.1 NMi/Hr CEP Rate 1800
EB(4)   = 9.8e-5;
EB(5)   = 1e-4;
EB(6)   = 0.01/3600/180*pi;      % 0.01/3600/180*pi for 0.1 NMi/Hr CEP Rate
...
title('~0.1 NMi/Hr ''HIGH ACCURACY'' INS');
%
figure;
...
%
%
response = input('Save error budget to file ''INSEBHiAcc.mat'' ?  (Yes or No): ','s');
if (response(1)=='Y')|(response(1)=='y')
    save 'INSEBHiAcc' 'EB';
    disp('Error budget saved to file INSEBHiAcc.mat');
end;
%
