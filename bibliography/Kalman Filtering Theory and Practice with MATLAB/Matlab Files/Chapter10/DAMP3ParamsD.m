function [Phi,Q,P] = DAMP3ParamsD(SigmaAcc,SigmaVel,SigmaPos,TauAcc,DeltaT);
%
% Computes discrete-time parameters of the DAMP3 stochastic model
% (defined as the sixth model in Table 10.2), given desired values:
%
