...
%SET Set properties of WINSERIAL objects.
%
% OBJ = SET(OBJ,'PropertyName',VALUE) sets the property 'PropertyName' of
% the WINSERIAL object OBJ to the value VALUE.
%
% OBJ = SET(OBJ,'PropertyName',VALUE,'PropertyName',VALUE,..) sets multiple
% property values of the WINSERIAL object OBJ with a single statement.
%
...
%                      19200/38400/57600/115200/128000/230400/256000/460800/921600
...
% Set Parity property.
scheme = {'even', 'mark', 'none', 'odd', 'space'};
switch value
  case scheme
    obj.Parity = value;
  otherwise
